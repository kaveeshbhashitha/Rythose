namespace Raythose.Models
{
    ...
    public class CreateAssessmentSample
    {
        ...
        public void createAssessment(string projectID = "raythos-1704597679225", string recaptchaKey = "6Ld5c0gpAAAAAH56v3mZpyySwYNQpG9eTTE2bSOS", string token = "action-token", string recaptchaAction = "action-name")
        {
